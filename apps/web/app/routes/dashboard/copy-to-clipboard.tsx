...
export function CopyToClipboardButton(props: CopyToClipboardButtonProps) {
  ...
  return (
    <button
      ...
      className="bg-indigo-600 text-white rounded-lg py-4 px-4 shadow-sm border-none outline-none ring-indigo-400 focus:(ring-4 ring-offset-2) focus-visble:(ring-4 ring-offset-2) hover:bg-indigo-500 flex items-center ml-1"
      onClick={() => {
